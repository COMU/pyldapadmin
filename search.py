...
def index(req):
    ...
    page += '<title>search page</title></head><body>'
    page+='<div>\
    ...
    <select name="scope" style="width: 200px">\
        <option selected="selected" value="ldap.SCOPE_SUBTREE">Sub (entire subtree)</option>\
...
def searching(req):
    ...
    page = template_page.page_header()+'<title>searching...</title></head><body>'
    if(1):
